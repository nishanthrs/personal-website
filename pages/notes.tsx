  ...
  return (
    <div className="flex flex-col h-screen justify-between">
      ...
      <div className="">
        ...
        <span className="block italic text-sm text-gray-500 sm:text-center dark:text-gray-400 my-4 mb-4">All images generated by <a href="https://github.com/Stability-AI/StableCascade" className="hover:underline">Stable Cascade</a> locally</span>
      </div>
