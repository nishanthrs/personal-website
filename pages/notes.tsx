  ...
  return (
    <div>
      ...
      <div className="absolute inset-x-0 bottom-0">
        ...
        <span className="block italic text-sm text-gray-500 sm:text-center dark:text-gray-400 my-6 mb-6">All images generated by <a href="https://stablediffusionweb.com/" className="hover:underline">Stable Diffusion XL</a></span>
      </div>
